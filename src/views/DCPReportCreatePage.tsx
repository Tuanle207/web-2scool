...
const DCPReportCreatePage: FC<Props> = () => {
  ...
  const sendingDcpReport = useSelector(LoadingSelector.sendingDcpReport);
  ...
  useEffect(() => {
    ...
    document.title = '2Cool | Tạo phiếu chấm điểm nề nếp';
  }, []);
    ...
    <div style={{ height: '100%' }}>
      <Grid container className={classes.container}>
        ...
        <Grid style={{ background: '#fff', flexGrow: 1 }} item container xs={8} sm={9} md={10} direction={'column'}>
          <Grid item>
            <Header pageName="Tạo phiếu chấm điểm nề nếp" hiddenSearchBar />
          </Grid>
          <Grid item container direction='column' style={{ flex: 1, minHeight: 0, flexWrap: 'nowrap', background: "#e8e8e8" }}>
            ...
            <Grid item container style={{ flexGrow: 1, padding: "16px 24px", backgroundColor: '#e8e8e8'}}>
...
export default DCPReportCreatePage;